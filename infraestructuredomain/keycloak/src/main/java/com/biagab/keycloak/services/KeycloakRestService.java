...
import com.biagab.keycloak.adapters.KeycloakClientAdapter;
...
public class KeycloakRestService {
   ...
   // @Autowired
   // private KeycloakClientAdapter keycloakClientAdapter;
    ...
    public String checkValidity(String token) throws Exception {
        ...
        //boolean v = keycloakClientAdapter.validateToken(token, keycloakTokenUri, "PaymentChain", clientId, clientSecret);
